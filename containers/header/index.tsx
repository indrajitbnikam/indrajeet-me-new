  ...
  return (
    <header className="text-gray-600">
      <div className="container mx-auto max-w-[1200px] flex flex-row flex-wrap p-5 items-center">
        <p
          className="cursor-pointer hover:animate-pulse flex title-font font-medium items-center text-2xl text-gray-700 dark:text-[#f8f7f1]"
        ...
        {(ref) => (
          <div className="md:hidden">
            ...
            >
              ...
              <div className="w-full text-center rounded-xl py-3 group hover:bg-sky-100 dark:hover:bg-[#e4cf59] dark:text-gray-400 hover:text-sky-800 dark:hover:text-gray-800">
                <p
                  className="font-semibold cursor-pointer"
                  onClick={() => navigateTo('/projects')}
                >
