  ...
  return (
    <header className='text-gray-600'>
      <div className='container mx-auto max-w-[1200px] flex flex-row flex-wrap p-5 items-center'>
        ...
        <nav className='flex-wrap items-center justify-center hidden text-base md:ml-auto md:flex'>
          <p
        ...
        <nav className='flex flex-wrap items-center justify-center ml-auto text-base md:hidden'>
